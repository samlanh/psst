...
class Accounting_UpdatestudentfeeController extends Zend_Controller_Action {
	...
	public function indexAction()
    {
    	try{
    		...
    		$collumns = array("BRANCH","ACADEMIC_YEAR","TYPE_STUDY","IS_MULTY_STUDY","TYPE","AMOUNT_STUDENT","LEARNING","STOP_STUDY","School Option","CREATE_DATE","PROCESS_TYPE","BY_USER","STATUS");
