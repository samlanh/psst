<?php
class Foundation_MajorController extends Zend_Controller_Action {
...
// 	    	$rs_rows = $glClass->getImgActive($rs_rows, BASE_URL, true);
	    	...
	    	$link=array(
	    			'module'=>'foundation','controller'=>'major','action'=>'edit',
	    	);
    	...
    	if($this->getRequest()->isPost()){
    		...
    		try {
    			...
    			if(!empty($_data['save_close'])){
    				Application_Form_FrmMessage::Sucessfull("ការ​បញ្ចូល​ជោគ​ជ័យ !", "/foundation/major/index");
    			}
//     			Application_Form_FrmMessage::Sucessfull("ការកែប្រែដោយជោគជ័យ", "/global/major/index");
    ...
    public function editAction(){
    	...
    	if($this->getRequest()->isPost()){
    		...
    		Application_Form_FrmMessage::Sucessfull("ការកែប្រែដោយជោគជ័យ", "/foundation/major/index");
    		}catch(Exception $e){
    			Application_Form_FrmMessage::message("Application Error");
    			Application_Model_DbTable_DbUserLog::writeMessageError($e->getMessage());
    		}
		...
		$abc = $this->view->teacherbyid = $db->getTeacherBySubjectID($id);
		//print_r($abc);exit();
    }
