<?php
class Foundation_StudentattendanceController extends Zend_Controller_Action {
		...
		if($this->getRequest()->isPost()){
			...
			try {
				if(isset($_data['save_new'])){
					 ...
					 Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS","/foundation/studentattendance/add");
				}else {
					 $rs =  $db->addStudentAttendece($_data);
