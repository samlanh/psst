<?php
class Issue_GradingsystemController extends Zend_Controller_Action {
	const REDIRECT_URL = '/issue/gradingsystem';
    ...
    {
    	try{
	    	$db = new Issue_Model_DbTable_DbGradingSystem();
	    	...
	    	$link=array(
	    			'module'=>'issue','controller'=>'gradingsystem','action'=>'edit',
	    	);
