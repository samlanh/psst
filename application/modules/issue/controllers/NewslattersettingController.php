<?php
class Issue_NewslattersettingController extends Zend_Controller_Action {
	const REDIRECT_URL = '/issue/newslattersetting';
    ...
    {
    	try{
	    	$db = new Issue_Model_DbTable_DbNewslatterSetting();
	    	...
	    	$link=array(
	    			'module'=>'issue','controller'=>'newslattersetting','action'=>'edit',
	    	);
    	...
    	$frm = new Issue_Form_FrmNewslatterSetting();
