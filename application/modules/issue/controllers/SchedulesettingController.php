<?php
class Issue_SchedulesettingController extends Zend_Controller_Action {
	const REDIRECT_URL = '/issue/schedulesetting';
	...
	public function indexAction()
    {
    	try{
	    	...
	    	$link=array(
	    			'module'=>'issue','controller'=>'schedulesetting','action'=>'edit',
	    	);
