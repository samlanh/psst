<?php
class Issue_SubjectareasettingController extends Zend_Controller_Action {
	const REDIRECT_URL = '/issue/subjectareasetting';
    ...
    {
    	try{
	    	$db = new Issue_Model_DbTable_DbSubjectAreaSetting();
	    	...
	    	$link=array(
	    			'module'=>'issue','controller'=>'subjectareasetting','action'=>'edit',
	    	);
    	...
    	$frm = new Issue_Form_FrmSubjectAreaSetting();
