<?php
class Issuesetting_NewslattersettingController extends Zend_Controller_Action {
	const REDIRECT_URL = '/issuesetting/newslattersetting';
    ...
    {
    	try{
	    	$db = new Issuesetting_Model_DbTable_DbNewslatterSetting();
	    	...
	    	$link=array(
	    			'module'=>'issuesetting','controller'=>'newslattersetting','action'=>'edit',
	    	);
    	...
    	$frm = new Issuesetting_Form_FrmNewslatterSetting();
    	$frm->FrmAddNewslatterSetting(null);
    ...
    public function addAction(){
    	...
    	if($this->getRequest()->isPost()){
    		...
    		try {
    			$sms="INSERT_SUCCESS";
    			$_major_id = $db->addNewslatterSetting($_data);
    ...
    public function editAction(){
    	...
    	$frm = new Issuesetting_Form_FrmNewslatterSetting();
    	$frm->FrmAddNewslatterSetting($row);
    	Application_Model_Decorator::removeAllDecorator($frm);
    	$this->view->frm_items = $frm;
    }
