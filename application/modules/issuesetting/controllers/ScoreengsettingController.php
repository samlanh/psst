<?php
class Issuesetting_ScoreengsettingController extends Zend_Controller_Action {
	const REDIRECT_URL = '/issuesetting/scoreengsetting';
    ...
    {
    	try{
	    	$db = new Issuesetting_Model_DbTable_DbScoreSetting();
