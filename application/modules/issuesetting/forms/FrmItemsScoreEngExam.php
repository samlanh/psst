<?php 
Class Issuesetting_Form_FrmItemsScoreEngExam extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddItemsScoreExam($data=null){
		...
		$this->addElements(array($_title,$_title_en,$note,$_status,$id));
