<?php 
Class Issuesetting_Form_FrmSubjectarea extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddSubjecArea($data=null){
		...
		$_type_opt = array(
				1=>$this->tr->translate("TYPE_ENTER_SCORE"),
				2=>$this->tr->translate("TYPE_CHOOSE_MENTION"));
		...
		$this->addElements(array($_title,$_title_en,$_type,$note,$_status,$id));
