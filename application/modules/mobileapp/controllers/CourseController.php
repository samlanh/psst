...
class Mobileapp_CourseController extends Zend_Controller_Action
{
	const REDIRECT_URL='/mobileapp/course';
	protected $tr;
...
public function indexAction(){
		try{
			$db = new Mobileapp_Model_DbTable_DbCourse();
			...
			$rs_rows= $db->getAllCourse($search);
			$list = new Application_Form_Frmtable();
			$collumns = array("TITLE","PUBLISH_DATE","ORDERING","BY_USER","STATUS");
			$link=array(
					'module'=>'mobileapp','controller'=>'course','action'=>'edit',
			);
		...
		$frm1 = new Mobileapp_Form_FrmCourse();
	   	$frm=$frm1->FrmAddCourse();
   ...
   function editAction(){
    	...
    	$frm = new Mobileapp_Form_FrmCourse();
	   	$frm=$frm->FrmAddCourse($row);
	   	Application_Model_Decorator::removeAllDecorator($frm);
	   	$this->view->frm_new = $frm;
