<?php
class Stock_ProductcategoryController extends Zend_Controller_Action {
		...
		if($this->getRequest()->isPost()){
			...
			try{
				...
				if(isset($_data['save_close'])){
					Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS","/stock/productcategory");
				}else{
					Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS","/stock/productcategory/add");
				}
	...
	public function editAction(){
		...
		if($this->getRequest()->isPost()){
			...
			try{
					...
					if(isset($_data['save_close'])){
						Application_Form_FrmMessage::Sucessfull("EDIT_SUCCESS","/stock/productcategory");
					}else{
						Application_Form_FrmMessage::Sucessfull("EDIT_SUCCESS","/stock/productcategory");
					}
